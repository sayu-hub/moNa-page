...
export default function Mona2Plus({ onBack }) {
  ...
  const features = [
    {
      ...
      description: "アクリルケース内にクッション材を配置するガスケットマウント構造を初採用。指への負担を軽減する柔らかな打鍵感と、さらに均一で上品なサウンドを実現しました。",
    ...
    },
    {
      ...
      description: "右上部にノブ（ロータリーエンコーダー）を標準搭載。音量調整やスクロール、ブラシサイズの変更など、専用ソフトから自由な機能を割り当てることができます。",
    ...
    {
      title: "至高のカスタマイズ環境",
      description: "QMK Firmware搭載。VIA/Remapを用いて、全てのキー配列とノブの回転アクションをブラウザ上からリアルタイムに変更可能です。",
    ...
    },
    {
      ...
      description: "Fキー（ファンクションキー）列と独立した矢印キーを備えた75%レイアウト。生産性を最大限に高めながらも、フルサイズキーボードより圧倒的にコンパクトです。",
            ...
            <div className="relative aspect-[4/3] bg-white rounded-[2.5rem] overflow-hidden shadow-xl ring-1 ring-slate-900/5">
              <div ref={carouselRef} className="flex overflow-x-auto scrollbar-hide snap-x snap-mandatory h-full w-full">
                <div className="snap-start shrink-0 w-full h-full">
                  <img src="https://images.unsplash.com/photo-1595225476474-87563907a212?auto=format&fit=crop&q=80&w=800" alt="moNa 2 Plus Main" className="w-full h-full object-cover"/>
                </div>
                <div className="snap-start shrink-0 w-full h-full relative">
                  ...
                  <img src="https://images.unsplash.com/photo-1515865261546-f94d0e82c5a0?auto=format&fit=crop&q=80&w=800" alt="moNa 2 Plus White" className="w-full h-full object-cover"/>
                </div>
                <div className="snap-start shrink-0 w-full h-full relative">
                  ...
                  <img src="https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?auto=format&fit=crop&q=80&w=800" alt="moNa 2 Plus Black" className="w-full h-full object-cover"/>
                </div>
                <div className="snap-start shrink-0 w-full h-full relative">
                  ...
                  <img src="https://images.unsplash.com/photo-1601445638532-3c6f6c3aa1d6?auto=format&fit=crop&q=80&w=800" alt="moNa 2 Plus Gray" className="w-full h-full object-cover"/>
                </div>
              </div>
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-full max-w-sm px-6 z-50">
        <div className="bg-slate-900/90 backdrop-blur-md text-white p-3 rounded-full shadow-2xl flex items-center justify-between border border-slate-700/50">
          <div className="pl-4 font-bold tracking-wide">
            moNa 2 Plus <span className="text-slate-400 font-normal text-xs ml-1">¥55,000</span>
          </div>
