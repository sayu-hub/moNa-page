...
import { Menu, X, ArrowRight, Twitter, Instagram, ChevronRight, Star, Sparkles, ArrowDown, BookOpen, Lightbulb, Package, CheckCircle, Keyboard, HelpCircle, ExternalLink } from 'lucide-react';

// ==========================================
// 1. データ定義 (旧 items.js の内容)
// ==========================================
const navLinks = [
  { name: 'News', href: '#news' },
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-emerald-100 selection:text-emerald-900 overflow-x-hidden relative">
      ...
      {/* Mobile Nav Overlay (Header要素のフィルターの影響を避けるため外に配置) */}
      ...
      <footer className="bg-slate-900 text-white py-16 border-t-4 border-emerald-600 relative z-10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8 relative">
          ...
          <div className="flex gap-8">
            ...
            <a href="#" className="text-slate-400 hover:text-white transition-colors text-sm font-bold hover:underline decoration-emerald-500 decoration-2 underline-offset-4">Shop</a>
          </div>
        </div>
